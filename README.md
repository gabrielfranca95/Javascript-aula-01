...
seguindo o exemplo para que possa ser interpretado um texto no terminal ou no navegador, além da palvra "console.log" deverá ser usado um abre e fecha parenteses contendo aspas dentro, e entre 
